...
class BoundaryLengthDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self.color_button.clicked.connect(lambda *args: self.choose_color())
        ...
        self.apply_button.clicked.connect(lambda *args: self.apply())
        self.clear_button.clicked.connect(lambda *args: self.clear())
